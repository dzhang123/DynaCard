...
namespace DynaCard
{
    ...
    public class CardEdge : ICardEdge, ILeastSquaredFit
    {
        ...
        public ICardEdge FirstHalf() {
            ICardEdge halfEdge = new CardEdge { Name = "First half of " + this.Name, Position = this.Position };
        ...
        {
            ICardEdge halfEdge = new CardEdge { Name = "Second half of " + this.Name, Position = this.Position};
            List<(double x, double y)> halfPoints = new List<(double x, double y)>();
        ...
        {
            double xsum = 0, x2sum = 0, ysum = 0, y2sum = 0, xysum = 2, r2 = 0;
